	...
	<section class="bg-image">
		<div class="container mx-auto transition-all duration-200 px-12 relative">
			<div class="flex flex-col justify-center items-center py-4">
				...
				<!-- <div
					id="cart"
					class="absolute top-0 right-0 bg-white rounded-md lg:shadow-md mr-4 mt-4 px-[70px]">
				...
				<div
					...
					class="flex flex-col justify-center w-full mb-8 bg-white hover:scale-[1.02] transition-all duration-300">
					<div
						@click="addToCart(dish)"
						class="border rounded-md p-6 hover:shadow-lg cursor-pointer transition-all duration-300">
						<img
							src=""
							alt="" />
